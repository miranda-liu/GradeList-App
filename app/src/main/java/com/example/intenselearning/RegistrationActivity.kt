    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button_registration_register.setOnClickListener {
            when {
                ...
                editText_registration_password.text.toString() != editText_registration_confirmPassword.text.toString() -> {
        ...
        // apply uses the object as a parameter and also returns it at the end
    }
    private fun registerUser(){
        ...
        Backendless.UserService.register(user, object : AsyncCallback<BackendlessUser?> {
            ...
            override fun handleFault(fault: BackendlessFault) {
                ...
                Log.d("RegistrationActivity", fault.detail)
            }
        })
    }
}